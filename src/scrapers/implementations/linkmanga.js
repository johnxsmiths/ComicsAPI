...
export class LinkMangaScraper extends BaseScraper {
  constructor() {
    super({ siteId: 'linkmanga', siteName: 'LinkManga', baseUrl: 'https://linkmanga.com', requiresHeadless: false });
  }
  ...
  async getDetails(mangaId) {
    ...
    return formatMangaDetails({ id: mangaId, siteId: this.siteId, title, coverUrl: cover ? ImageProxy.buildWsrvUrl(cover, { quality: 85 }) : null, author: 'LinkManga', status: 'ONGOING', genres: ['Manga'], chapters });
  }
